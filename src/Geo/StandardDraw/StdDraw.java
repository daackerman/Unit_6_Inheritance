/******************************************************************************
 *  Compilation:  javac StandardDraw.java
 *  Execution:    java StandardDraw
 *  Dependencies: none
 *
...
/**
 *  The {@code StandardDraw} class provides a basic capability for
 *  creating drawings with your programs. It uses a simple graphics model that
 ...
 *  <p>
 *  <b>Getting started.</b>
 *  To use standard drawing, you must have {@code StandardDraw.class} in your
 *  Java classpath. If you used our autoinstaller, you should be all set.
 *  Otherwise, download
 *  <a href = "http://introcs.cs.princeton.edu/java/stdlib/StdDraw.java">StandardDraw.java</a>
 ...
 *           StandardDraw.setPenRadius(0.05);
 *           StandardDraw.setPenColor(StandardDraw.BLUE);
 *           StandardDraw.point(0.5, 0.5);
 *           StandardDraw.setPenColor(StandardDraw.MAGENTA);
 *           StandardDraw.line(0.2, 0.2, 0.8, 0.2);
 *       }
 *   }
 *  </pre>
 ...
 *  The methods {@code StandardDraw.line()} and {@code StandardDraw.point()}
 *  draw lines and points; the methods {@code StandardDraw.setPenRadius()}
 *  and {@code StandardDraw.setPenColor()} control the line thickness and color.
 *  <p>
 ...
 *  and represented in degrees. For example, {@code StandardDraw.arc(0.0, 0.0, 1.0, 0, 90)}
 ...
 *   StandardDraw.filledPolygon(x, y);
 *  </pre>
 *  <p>
 *  <b>Pen size.</b>
 ...
 *  </ul>
 *  <p>
 *  For example, {@code StandardDraw.setPenRadius(0.025)} makes
 ...
 *  For example, {@code StandardDraw.setPenColor(StandardDraw.MAGENTA)} sets the
 ...
 *  For example, {@code StandardDraw.setCanvasSize(800, 800)}
 ...
 *  leave a small margin, you can call {@code StandardDraw.setScale(-.05, 1.05)}.
 *  <p>
 ...
 *   StandardDraw.setFont(font);
 *   StandardDraw.text(0.5, 0.5, "Hello, World");
 *  </pre>
 *  <p>
 *  <b>Images.</b>
 ...
 *  {@code StandardDraw.clear(StandardDraw.LIGHT_GRAY)} clears the canvas to a shade
 *  of gray.
 *  <p>
 ...
 *       double y = Math.cos(t);
 *       StandardDraw.clear();
 *       StandardDraw.filledCircle(x, y, 0.05);
 *       StandardDraw.filledCircle(-x, -y, 0.05);
 *       StandardDraw.show();
 *       StandardDraw.pause(20);
 *   }
 *  </pre>
 *  <p>
...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    ***************************************************************************/
     ...
     * {@code StandardDraw.BLACK}, {@code StandardDraw.BLUE}, {@code StandardDraw.CYAN},
     * {@code StandardDraw.DARK_GRAY}, {@code StandardDraw.GRAY}, {@code StandardDraw.GREEN},
     * {@code StandardDraw.LIGHT_GRAY}, {@code StandardDraw.MAGENTA}, {@code StandardDraw.ORANGE},
     * {@code StandardDraw.PINK}, {@code StandardDraw.RED}, {@code StandardDraw.WHITE}, and
     * {@code StandardDraw.YELLOW}.
     *
    ...
    ***************************************************************************/
    ...
    private static Image getImage(String filename) {
        ...
        // in case file is inside a .jar (classpath relative to StandardDraw)
        if ((icon == null) || (icon.getImageLoadStatus() != MediaTracker.COMPLETE)) {
...
/*
    private static BufferedImage getImage(String filename) {
        ...
        // in case file is inside a .jar (classpath relative to StandardDraw)
        try {
            URL url = StandardDraw.class.getResource(filename);
            BufferedImage image = ImageIO.read(url);
            return image;
        } 
        catch (IOException e) {
